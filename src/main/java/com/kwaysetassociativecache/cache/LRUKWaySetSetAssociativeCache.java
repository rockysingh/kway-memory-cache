...
import com.kwaysetassociativecache.algorithm.LRUCache;
import java.util.ArrayList;
import java.util.List;

public class LRUKWaySetSetAssociativeCache<K,V> extends KWaySetAssociativeCache<K,V> {

    private int nSets;
    private int nWay;
    
    public LRUKWaySetSetAssociativeCache(int nSets, int nWay){
        this.nSets = nSets;
        this.nWay = nWay;
